...
function attachRouterServerSsrUtils({ router, manifest: manifest2, getRequestAssets }) {
  ...
  const callListeners = (listeners2, errorPrefix) => {
    const snapshot = listeners2.slice();
  ...
  const removeListener2 = (listeners2, listener) => {
  ...
  const serverSsr = {
    ...
    dehydrate: async (opts) => {
      ...
      const signalSerializationComplete = () => {
        ...
        const listeners2 = serializationFinishedListeners.slice();
        serializationFinishedListeners.length = 0;
        for (const l of listeners2) try {
          l();
        } catch (err) {
    ...
    onInjectedHtml: (listener) => {
      ...
      return () => removeListener2(injectedHtmlListeners, listener);
    },
    ...
    onSerializationFinished: (listener) => {
      ...
      return () => removeListener2(serializationFinishedListeners, listener);
    },
    onCleanup: (listener) => {
      if (cleanupStarted) return;
    ...
    setRenderFinished: () => {
      ...
      const listeners2 = renderFinishedListeners.slice();
    ...
    cleanup() {
      if (cleanupStarted) return;
      cleanupStarted = true;
      const listeners2 = cleanupListeners.slice();
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DciDH3Id.js");
...
const manifest = {
  "093a08c04a040019d99379d441a551d685398636abb70dc186413077309aba3f": {
    functionName: "listHoldings_createServerFn_handler",
    importer: () => import("./portfolio-IVeZm_87.js")
  },
  "423814c46ccea2f96f45773aa5c86386e3412003bc039b59903b1ded3582e370": {
    functionName: "addHolding_createServerFn_handler",
    importer: () => import("./portfolio-IVeZm_87.js")
  },
  "516fc0ed0122f17fde01f478272f253a8c2e071e048f3fda6c42f73ba37ef26e": {
    functionName: "listEtfs_createServerFn_handler",
    importer: () => import("./etfs-Dz8vDmuW.js")
  },
  "5e22afacbfa95f0c269e78516aad11be99d61a2e781c02a2cf9d44982ebdb8e4": {
    functionName: "setHoldingAmount_createServerFn_handler",
    importer: () => import("./portfolio-IVeZm_87.js")
  },
  "966f1d465458ac628a0f5ed28f2fe1e01126d5b764b3463f8d5c662a181227ea": {
    functionName: "listBanks_createServerFn_handler",
    importer: () => import("./banks-B4tyVxRy.js")
  },
  "bad3290d423157d7ddcd5256ee9b0c9c99dea0745eb675e7cca360f4b47396ed": {
    functionName: "removeHolding_createServerFn_handler",
    importer: () => import("./portfolio-IVeZm_87.js")
  }
};
...
async function executeMiddleware$1(middlewares, env2, opts) {
  ...
  const callNextMiddleware = async (ctx) => {
    ...
    try {
      ...
      if (validator && env2 === "server") ctx.data = await execValidator(validator, ctx.data);
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-aMmKAEBC.js").then((n2) => n2.H),
