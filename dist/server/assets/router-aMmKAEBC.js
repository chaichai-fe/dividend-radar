...
function daysSince(date) {
  const then = (/* @__PURE__ */ new Date(`${date}T00:00:00`)).getTime();
...
const STORAGE_KEY = "dividend-radar-theme";
...
const appCss = "/assets/styles-Bbka7zYP.css";
const Route$4 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "汇总 A 股红利 ETF 的净值与股息率，做低估/高估估值评级与加仓建议，并管理你的红利组合、测算组合股息率与年被动收入。"
      },
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "zh-CN", suppressHydrationWarning: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("style", { dangerouslySetInnerHTML: { __html: criticalCss } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "app-loader", "aria-hidden": "true", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dr-ring" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dr-word", children: "红利雷达" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dr-sub", children: "正在加载行情…" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AppReady, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "site-header sticky top-0 z-30 border-b border-border backdrop-blur", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-wrap flex h-16 items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Link,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Gauge, { className: "size-5 text-[var(--lagoon-deep)]" }),
                    "红利雷达"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden items-center gap-5 md:flex", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: item.to,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "page-wrap flex items-center gap-5 pb-3 md:hidden", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: item.to,
              activeOptions: { exact: item.exact },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "page-wrap py-8", children }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "site-footer mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-wrap py-6 text-xs text-muted-foreground", children: "数据来源于公开网络（东方财富 / 腾讯行情 / 红利查等），股息率与估值区间为参考值， 净值为实时抓取。本站仅供学习研究，不构成任何投资建议。" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceWorkerRegistrar, {}),
...
const listEtfs = createServerFn({
  method: "GET"
}).handler(createSsrRpc("516fc0ed0122f17fde01f478272f253a8c2e071e048f3fda6c42f73ba37ef26e"));
const listBanks = createServerFn({
  method: "GET"
}).handler(createSsrRpc("966f1d465458ac628a0f5ed28f2fe1e01126d5b764b3463f8d5c662a181227ea"));
const listHoldings = createServerFn({
  method: "GET"
}).handler(createSsrRpc("093a08c04a040019d99379d441a551d685398636abb70dc186413077309aba3f"));
const addHolding = createServerFn({
  method: "POST"
}).validator((data) => data).handler(createSsrRpc("423814c46ccea2f96f45773aa5c86386e3412003bc039b59903b1ded3582e370"));
const setHoldingAmount = createServerFn({
  method: "POST"
}).validator((data) => data).handler(createSsrRpc("5e22afacbfa95f0c269e78516aad11be99d61a2e781c02a2cf9d44982ebdb8e4"));
const removeHolding = createServerFn({
  method: "POST"
}).validator((data) => data).handler(createSsrRpc("bad3290d423157d7ddcd5256ee9b0c9c99dea0745eb675e7cca360f4b47396ed"));
const $$splitComponentImporter$3 = () => import("./portfolio-CVs_jWH7.js");
const Route$3 = createFileRoute("/portfolio")({
  ...
  loader: async ({
    ...
    await Promise.all([qc.ensureQueryData({
      queryKey: ["etfs"],
      queryFn: () => listEtfs()
    }), qc.ensureQueryData({
      queryKey: ["banks"],
...
const $$splitComponentImporter$2 = () => import("./etfs-CsDsvQdc.js");
const Route$2 = createFileRoute("/etfs")({
...
const $$splitComponentImporter$1 = () => import("./banks-DpNfOS5X.js");
const Route$1 = createFileRoute("/banks")({
...
const $$splitComponentImporter = () => import("./index-B0UZoaQT.js");
...
const EtfsRoute = Route$2.update({
  id: "/etfs",
  path: "/etfs",
  getParentRoute: () => Route$4
});
const BanksRoute = Route$1.update({
  id: "/banks",
  path: "/banks",
  getParentRoute: () => Route$4
});
...
function getRouter() {
  ...
  setupRouterSsrQueryIntegration({ router: router2, queryClient: context.queryClient });
  return router2;
}
