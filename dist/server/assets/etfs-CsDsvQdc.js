import { r as reactExports, W as jsxRuntimeExports, a2 as React2 } from "./worker-entry-sq6vnRaQ.js";
import { u as useQuery, e as equityBondSpread, v as valuateMulti } from "./rating-C6hI9CkT.js";
import { c as createLucideIcon, k as createSlot, m as reactDomExports, o as useComposedRefs, d as cn, B as Button, p as daysSince, t as toast, u as useQueryClient, e as addHolding, l as listEtfs } from "./router-aMmKAEBC.js";
import { V as ValuationBar, R as RatingBadge } from "./rating-badge-DhvFeGvQ.js";
...
function EtfsPage() {
  ...
  const [sort, setSort] = reactExports.useState("valuation");
  ...
  const visible = reactExports.useMemo(() => {
    ...
    let list = enriched.filter(({
      ...
      if (kw) {
        const hay = `${etf.name}${etf.code}${etf.indexName}${etf.manager}`.toLowerCase();
        if (!hay.includes(kw)) return false;
      }
      if (filter === "buy") return valuation.worthBuying;
      if (filter === "undervalued") return valuation.level === "undervalued" || valuation.level === "deep-undervalued";
      if (filter === "fair") return valuation.level === "fair";
      if (filter === "watch") return valuation.level === "slightly-high" || valuation.level === "overvalued";
      return true;
    });
    list = [...list].sort((a, b) => {
      switch (sort) {
  ...
  const avgYield = enriched.length > 0 ? enriched.reduce((s, e) => s + e.etf.dividendYield, 0) / enriched.length : 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rise-in space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-end justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "island-kicker", children: "Valuation" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "display-title mt-1 text-3xl font-bold text-foreground", children: "红利 ETF 估值榜" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-sm text-muted-foreground", children: [
          "汇总 A 股 ",
          rows.length,
          " 只主流红利 ETF 的净值与股息率，按“股息率 + PB + PE 多因子历史分位”评级低估 / 高估与加仓价值。"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-right text-xs text-muted-foreground", children: query.data ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { title: "股息率、PE、PB、估值区间为指数层面静态维护数据，仅净值实时。", className: cn(isStale && "font-medium text-amber-600 dark:text-amber-400"), children: [
            "估值数据 ",
            dataDate || "—",
            dataDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1", children: [
              "（",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "收录红利 ETF", value: `${rows.length}`, unit: "只" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "当前值得加仓", value: `${buyCount}`, unit: "只", accent: true }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 min-w-[220px]", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: keyword, onChange: (e) => setKeyword(e.target.value), placeholder: "搜索名称 / 代码 / 指数 / 基金公司", className: "pl-9" })
      ] }),
    ...
    isStale && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-2.5 text-xs text-amber-700 dark:text-amber-300", children: [
      "估值数据（股息率 / PE / PB / 估值区间）为指数层面静态维护，已更新于",
      " ",
      staleDays,
      " 天前（",
      dataDate,
      "），可能与最新值存在偏差；净值与涨跌幅仍为实时。请以指数公司/基金公告为准。"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "island-shell overflow-hidden rounded-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border text-left text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium", children: "ETF / 跟踪指数" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium", children: "PE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 font-medium", children: "PB" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SortableTh, { label: "规模(亿)", active: sort === "scale", onClick: () => setSort("scale") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SortableTh, { label: "低估程度", active: sort === "valuation", onClick: () => setSort("valuation") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        query.isLoading && Array.from({
          length: 8
        }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", colSpan: 10, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-full" }) }) }, i)),
        visible.map(({
          etf,
          valuation,
          spread
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-foreground", children: etf.name }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium tabular-nums text-foreground", children: etf.nav.toFixed(3) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("text-xs tabular-nums", etf.changePct > 0 ? "text-rose-500" : etf.changePct < 0 ? "text-emerald-500" : "text-muted-foreground"), children: [
              etf.changePct > 0 ? "+" : "",
              etf.changePct.toFixed(2),
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 font-semibold tabular-nums text-foreground", title: `跟踪指数股息率（成份股加权，静态维护，截至 ${dataDate || "—"}），按实时净值折算；非基金实际分派率。`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 tabular-nums text-muted-foreground", title: `指数 PE（静态，截至 ${dataDate || "—"}）`, children: etf.pe.toFixed(1) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 tabular-nums text-muted-foreground", title: `指数 PB（静态，截至 ${dataDate || "—"}）`, children: etf.pb.toFixed(2) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 tabular-nums text-muted-foreground", children: etf.scale.toFixed(1) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ValuationBar, { valuation }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RatingBadge, { valuation }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: () => setTarget(etf), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "size-4" }),
            "加入"
          ] }) })
        ] }, etf.code)),
        !query.isLoading && visible.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-10 text-center text-muted-foreground", colSpan: 10, children: "没有匹配的红利 ETF" }) })
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "股息率为",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "跟踪指数的成份股加权股息率" }),
      "（静态维护，截至 ",
      dataDate || "—",
      "），按实时净值折算，反映底层资产收益水平， 并非基金实际分派率；PE / PB / 估值区间同为指数层面静态参考。仅净值与涨跌幅为实时数据。 本工具仅供学习研究，不构成投资建议。"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AddDialog, { etf: target, onClose: () => setTarget(null) })
  ] });
}
function StatCard({
  label,
...
function FactorRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-12 shrink-0 text-muted-foreground", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 flex-1 overflow-hidden rounded-full bg-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full rounded-full bg-[var(--lagoon-deep)]", style: {
      width: `${Math.min(100, Math.max(0, value))}%`
    } }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "w-9 shrink-0 text-right tabular-nums text-foreground", children: [
      value,
      "%"
    ] })
  ] });
...
function AddDialog({
  ...
  const [shares, setShares] = reactExports.useState("1000");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: Boolean(etf), onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { children: etf && valuation && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { children: [
        ...
        etf.dividendYield.toFixed(2),
        "%｜",
        /* @__PURE__ */ jsxRuntimeExports.jsx(RatingBadge, { valuation, className: "ml-1" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "rounded-lg bg-muted/60 p-3 text-xs text-muted-foreground", children: [
        etf.indexDesc,
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "加仓建议：" }),
        valuation.advice
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/60 p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center justify-between text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "多因子便宜度分位" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FactorRow, { label: "股息率", value: valuation.factors.yield }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FactorRow, { label: "PB", value: valuation.factors.pb }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(FactorRow, { label: "PE", value: valuation.factors.pe })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-[11px] leading-relaxed text-muted-foreground", children: "权重 股息率 50% · PB 30% · PE 20%。红利指数偏金融/周期，PB 比 PE 更具参考性。" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium", children: "买入份数（份）" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", value: shares, onChange: (e) => setShares(e.target.value), min: 0, step: 100 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "现价 ",
          etf.nav.toFixed(3),
          " · 市值 ≈ ¥",
          ((Number(shares) || 0) * etf.nav).toLocaleString(void 0, {
            maximumFractionDigits: 0
          }),
          "｜预计年分红 ≈ ¥",
          ((Number(shares) || 0) * etf.nav * (etf.dividendYield / 100)).toLocaleString(void 0, {
            maximumFractionDigits: 0
          })
        ] })
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: onClose, disabled: saving, children: "取消" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: confirm, disabled: saving, children: saving ? "加入中…" : "确认加入" })
    ] })
  ] }) }) });
}
export {
  EtfsPage as component
};
